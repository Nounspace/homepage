  ...
  return (
    <>
      <Box borderRadius="2xl" border="1px solid" borderColor="gray.300" p="4">
        ...
        <Text>
          1. Earliest access to customize your space
        </Text>
        <Text>
          2. Free, premium Nounspace access for life
        </Text>
        <Text>
          3. Infinite Possibilities
        </Text>
        <Text mt="4">
          Mint today with the fidget on the right! →→→
        </Text>
      </Box>
    </>
  )
  ...
  return (
    <Box borderRadius="2xl" border="1px solid" borderColor="gray.300" overflow="hidden" w="100%" h="100%" position="relative">
      <video width="100%" height="100%" controls>
        <source src="https://file.notion.so/f/f/a627b1bc-d532-4123-8c29-ec2e9f85b186/ee7f5b1b-09e0-47e6-8068-777eddd24b29/Nounspace_v2.mp4?id=6bba813a-b76b-4122-9056-c4a2605351ab&table=block&spaceId=a627b1bc-d532-4123-8c29-ec2e9f85b186&expirationTimestamp=1718402400000&signature=hx5djSMPf0JFrCfw794WS20L6cTqdfoe-3G4_mjyaQ4&downloadName=Nounspace+v2.mp4" type="video/mp4" />
...
const MintTab = () => {
  return (
    <>
      <Stack direction={{ base: 'column', md: 'row' }} align='stretch' spacing={6} mt={4}>
